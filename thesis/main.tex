...
\前序格式化
\摘要标题
\input{sections/thesis/abstract.tex} % 论文摘要

\目录\clearpage % 目录及换页

\正文格式化
\input{sections/thesis/introduction.tex}
\input{sections/thesis/background.tex}\clearpage
%\input{sections/thesis/abstract.tex}
%\input{sections/thesis/disclaimer.tex}
